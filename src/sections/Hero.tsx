    ...
    <div className="container">
      <div className="md:flex items-center">
        ...
        <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
          ...
          }} src={cylinder.src} alt='Cylinder image' width={220} height={220} className='hidden md:block -top-5 -left-32 md:absolute' />
          <motion.img style={ {
            rotate:30,
            translateY: translateY,
          }} src={noodleImage.src} alt='Noodle image' width={220} className='hidden lg:block top-[524px] left-[448px] md:absolute rotate-[30deg]' />
        </div>
      </div>
    </div>
  </section>;
